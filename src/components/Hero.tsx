...
const Hero: React.FC = () => {
    return (
        <div className="border-b border-neutral-900 pb-4 px-20"> 
            <div className=" flex flex-wrap"> 
                <div className="w-full lg:w-1/2">
                    <div className="flex flex-col items-center lg:items-start">
                        <h1 className="pb-16 text-6xl font-thin tracking-tight lg:mt-20 lg:text-7xl 2xl:text-8xl">Ben Guerrieri</h1>
